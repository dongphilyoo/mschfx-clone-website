...
const PROJECT_TITLE = "MSCHF X CLONE WEBSITE";
const PROJECT_SHORT_TITLE = "MSCHF X";
const PROJECT_DESCRIPTION = "This is a cloned website of MSCHF X";
const PROJECT_KEYWORDS = "MSCHF, MSCHF X, Front-end, Web, Vue"; // add more
