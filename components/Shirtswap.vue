<template>
  <div class="shirt-stack-container shadowed">
    <div class="shirt-stack-left">
      <div id="stack">
        <div class="card card1">
          <img src="~/assets/img/shirt-svg/shirt1-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt1.svg"
            alt=""
            class="shirt-overlay hide"
          />
        </div>
        <div class="card card2">
          <img src="~/assets/img/shirt-svg/shirt2-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt2.svg"
            alt=""
            class="shirt-overlay"
          />
        </div>
        <div class="card card3">
          <img src="~/assets/img/shirt-svg/shirt3-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt3.svg"
            alt=""
            class="shirt-overlay"
          />
        </div>
        <div class="card card4">
          <img src="~/assets/img/shirt-svg/shirt4-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt4.svg"
            alt=""
            class="shirt-overlay"
          />
        </div>
        <div class="card card5">
          <img src="~/assets/img/shirt-svg/shirt5-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt5.svg"
            alt=""
            class="shirt-overlay"
          />
        </div>
        <div class="card card6">
          <img src="~/assets/img/shirt-svg/shirt6-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt6.svg"
            alt=""
            class="shirt-overlay"
          />
        </div>
        <div class="card card7">
          <img src="~/assets/img/shirt-svg/shirt7-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt7.svg"
            alt=""
            class="shirt-overlay"
          />
        </div>
        <div class="card card8">
          <img src="~/assets/img/shirt-svg/shirt8-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt8.svg"
            alt=""
            class="shirt-overlay"
          />
        </div>
        <div class="card card9">
          <img src="~/assets/img/shirt-svg/shirt9-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt9.svg"
            alt=""
            class="shirt-overlay"
          />
        </div>
        <div class="card card10">
          <img src="~/assets/img/shirt-svg/shirt10-blue.svg" alt="" />
          <img
            src="~/assets/img/shirt-svg/shirt10.svg"
            alt=""
            class="shirt-overlay"
          />
        </div>
      </div>
      <div class="shirt-stack-bottom"><span>CLICK CLICK CLICK</span></div>
    </div>
    <div class="shirt-stack-side">
      <svg
        id="Layer_1"
        version="1.1"
        ...
        y="0px"
        viewBox="0 0 69 391"
        style="enable-background:new 0 0 69 391;"
        xml:space="preserve"
      >
        <style type="text/css">
          .st0 {
        ...
        <g id="Pre-Drop">
          <g
            id="Mobile-_x7C_-Launch-State"
            transform="translate(-314.000000, -174.000000)"
          >
            <g id="HOMEPAGE" transform="translate(-13.000000, 173.000000)">
              <g id="FPO--3D-render" transform="translate(44.000000, 1.000000)">
                <g id="brandlogos" transform="translate(283.000000, 0.000000)">
                  <path
                    id="offwhite"
                    class="st0"
                    d="M42.6,328c0,0.1-0.1,1.4-0.1,2.8c0,2.2,0,2.6,0.1,2.6c0.1,0,1.9,0.1,4,0.1
                  ...
                  <path
                    id="chinatownmarket"
                    class="st0"
                    d="M44.6,295.2c0.2,0.7,0.4,1.5,0.6,2.3c0,0.2-0.1,0.5-0.3,0.6
                  ...
                  <path
                    id="kith"
                    class="st0"
                    d="M47.2,224.2v2.9h5.1v-5.8h3.1v15h-3.1V230h-5v6.3h-3.1v-15h3.1V224.2z M41.6,222.6v1.3h-3.8
                  ...
                  <path
                    id="palace"
                    class="st0"
                    d="M50.9,202.4c1.1,0.5,1.4,0.9,1,2.3c-0.2,0.6-0.5,1.2-0.8,1.7h-2.9c0.2-0.7,0.8-1.3,0.7-2
                  ...
                  <path
                    id="BAPE"
                    class="st0"
                    d="M41.7,126.5c3.5,1.2,6.2,3.4,8.2,6.4c1.8,2.7,3.1,5.6,4.5,8.6c1.1,2.4,2,4.9,2.6,7.4
                  ...
                  <path
                    id="stussy"
                    class="st0"
                    d="M27.2,97.2c0,0,0,0.1,0,0.2c0,0,0,0,0.1,0c0.1,0,0.1-0.1,0.2-0.1c0.1,0,0.1,0.1,0.2,0.1
                  ...
                  <path
                    id="adidas"
                    class="st0"
                    d="M53.8,85.3c1.8,0,3.2,1.1,3.3,2.6l0,0.2l-1.8,0c-0.1-0.7-0.7-1.2-1.5-1.2
                  ...
                  <path
                    id="North-Face"
                    class="st0"
                    d="M45.9,76.2h-3.5V69h1.3c0.6,0,1.1,0.2,1.6,0.6c0.4,0.4,0.6,0.9,0.6,1.6V76.2z M51.7,76.2
                  ...
                  <path
                    id="Supreme"
                    class="st1"
                    d="M58.9,11.6v18.5H7.7V11.6H58.9z M27.3,17.3c-0.6,0-1.3,0.3-1.8,0.7l-0.1,0.1l0.1-0.6h-1.9
                  ...
                  <path
                    id="kith_1_"
                    class="st0"
                    d="M7.6,41.6v9.2h51.2V32.4H7.6V41.6z"
                  />
                </g>
              </g>
            </g>
  ...
  mounted() {
    ...
    function cardChange(cards) {
      ...
      setTimeout(() => {
        ...
        document
          .querySelector(".card-backward")
          .classList.remove("card-backward");
      }, 800);
    }
  },
  beforeDestroy() {
...
.shirt-stack-bottom {
  ...
  text-align: center;
  font-size: calc(9px + (32 - 14) * ((100vw - 300px) / (1600 - 300)));
  ...
  span.outlined {
    -webkit-text-stroke: 0.7px #190dfe;
    color: #efefff;
  }
}
